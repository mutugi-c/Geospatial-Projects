...
- [Live Demo Link](https://mutugi-c.github.io/Geospatial-Projects/)
...
```sh
 $ cd my-folder
 $ git clone git@github.com:mutugi-c/Geospatial-Projects.git
```

### Deployment

You can deploy this project using build tools such as webpack, Rollup, Parcel, e.t.c:
...
I would like to thank the [GEM Joint Master programme](https://www.gem-msc.eu/) for the opportunity to learn and grow my Geo-ICT skills.
